        ...
        (function (view) {
            var GameHeader = (function (_super) {
                ...
                GameHeader.prototype.addObjects = function () {
                    ...
                    levelIcon.addEventListener("click", function () { this.levelUpEffect(); });
                ...
                GameHeader.prototype.levelUpEffect = function () {
                    ...
                    createjs.Tween.removeTweens(this.levelBar.mask);
                    createjs.Tween.get(this.levelBar.mask).to({ scaleX: 1 }, 100, createjs.Ease.quadIn).call(function () { this.levelBar.mask.scaleX = 0; });
