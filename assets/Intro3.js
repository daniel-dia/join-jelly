...
(lib.Intro3 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1137).call(this.frame_1137).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1046).to({_off:false},0).to({alpha:1},46).to({alpha:0},45).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(914).to({_off:false},0).to({x:47.3,y:605.8,startPosition:60},178,cjs.Ease.get(0.98)).to({_off:true},2).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(795).to({_off:false},0).to({_off:true},119).wait(224));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(615).to({_off:false},0).to({y:341.5,startPosition:60},178,cjs.Ease.get(1)).to({_off:true},2).wait(343));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(435).to({_off:false},0).to({regX:51.6,scaleX:0.8,scaleY:0.8,x:777.2,y:182.5,startPosition:60},178,cjs.Ease.get(1)).to({_off:true},2).wait(523));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(256).to({_off:false},0).to({x:885.4,y:3004.9,startPosition:60},177,cjs.Ease.get(1)).to({_off:true},2).wait(703));

	// Layer 1
	this.instance_13 = new lib.Scene1("synched",0,false);
	this.instance_13.setTransform(782,430,1,1,0,0,0,62.1,-1330.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({x:894.1,y:-569.5,startPosition:117},255,cjs.Ease.get(0.99)).to({_off:true},1).wait(882));
